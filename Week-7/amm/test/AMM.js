...
describe('Token', () => {
    ...
    describe('Swapping Tokens', () => {
        ...
        it('facilitates swaps', async () => {
            ...
            // Expect pool to have 100 shares
            ...
            console.log(`Price: ${await amm.token2Balance() / await amm.token1Balance()} USD`);
            ...
            console.log(`\t Investor1 Token2 balance before swap: ${ethers.utils.formatEther(balance)} ETH \n`);
            ...
            console.log(`\t Token2 amount Investor1 will receive after swap: ${ethers.utils.formatEther(estimate)} ETH \n`);
            ...
            balance = await token2.balanceOf(investor1.address);
            console.log(`\t Investor1 Token2 balance after swap: ${ethers.utils.formatEther(balance)} ETH \n`);
            ...
            console.log(`\t Investor2 Token1 balance before swap: ${ethers.utils.formatEther(balance)} ETH \n`);
            ...
            console.log(`\t Token1 amount Investor2 will receive after swap: ${ethers.utils.formatEther(estimate)} ETH \n`);
            ...
            // Removing Liquidity
            ////////////////////////////////////////////////////////////////
            console.log(`\t AMM Token1 balance: ${ethers.utils.formatEther(await amm.token1Balance())} ETH \n`);
            console.log(`\t AMM Token2 balance: ${ethers.utils.formatEther(await amm.token2Balance())} ETH \n`);

            // Check LP balance before removing tokens
            balance = await token1.balanceOf(liquidityProvider.address);
            console.log(`\t LP Token1 balance before removing funds: ${ethers.utils.formatEther(balance)} ETH \n`);

            balance = await token2.balanceOf(liquidityProvider.address);
            console.log(`\t LP Token2 balance before removing funds: ${ethers.utils.formatEther(balance)} ETH \n`);
            ...
            balance = await token1.balanceOf(liquidityProvider.address);
            console.log(`\t LP Token1 balance after removing funds: ${ethers.utils.formatEther(balance)} ETH \n`);

            balance = await token2.balanceOf(liquidityProvider.address);
            console.log(`\t LP Token2 balance after removing funds: ${ethers.utils.formatEther(balance)} ETH \n`);
